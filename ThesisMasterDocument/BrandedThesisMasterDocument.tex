...
\begin{document}
    ...
    \chapter{Survey Contents}\label{survey-contents}
        ...
        \section{Experimental Protocol}
            ...
            The data was collected in a single session lasting around 30mins with each participant. Each session started with the participant having to complete the first questionnaire and the fill out the form of consent to the participation. At this stage potential hazards and problems and dispositions as discussed in section \ref{considerations} are identified.
