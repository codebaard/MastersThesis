...
\begin{document}
    ...
    \chapter{Survey Framework}\label{survey-framework}
        ...
        \section{Information Transfer Rate}\label{itr}
            ...
            \begin{figure}[h]     % h=here, t=top, b=bottom, p=page
                \centering
                \includegraphics[width=0.8\textwidth]{placeholder.jpg} 
                \caption{Timing of symbol recognition and activation \todo{/ create picture, revisit caption}}\label{itr-timing}
            \end{figure}
    ...
    \chapter{Survey Contents}\label{survey-contents}
        ...
        \section{What data will be collected}\label{datacollection}
            ...
            The data collection will be structured in two blocks: Questions which the participant will be asked directly. The answers are given by the participant on the tablet mentioned in the previous section:
        ...
        \section{How are the age groups structured}
            ...
            \todo{Mail an Anna Wolf - warte auf Rückmeldung}
