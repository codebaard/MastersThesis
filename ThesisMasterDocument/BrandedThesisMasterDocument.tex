    ...
    \chapter{Introduction}\label{introduction}
        ...
        \section{Related work}\label{related-work}
            ...
            \begin{itemize}
                ...
                \item NeurIPS (\textit{Neural Informations Processing Systems})
            \end{itemize}
            ...
            To narrow the scope, where this research paper is located at, the considerations from section \ref*{use-case} are taken into accout. As already established in section \ref*{working-principle}, the sensor used in this study uses VEP and is non-invasive in nature. Therefore the general scope of this research is located in the realm of \textit{non-invasive BCI based on VEP used for HCI}.
