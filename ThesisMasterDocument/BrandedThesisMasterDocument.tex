...
\begin{document}
    ...
    \chapter{Introduction}\label{introduction}
        ...
        \section{Working principle}\label{working-principle}         
            ...
            \begin{figure}[h]     % h=here, t=top, b=bottom, p=page
                \centering
                \includegraphics[width=0.8\textwidth]{Illu_Kopf2.jpg} 
        ...
        \section{Establishing a use-case}\label{use-case-main}
            ...
            \subsection{Constraints of a participatory study}
                ...
                \begin{figure}[h]     % h=here, t=top, b=bottom, p=page
                    \centering
                    \includegraphics[width=0.8\textwidth]{einzelauswertung_en.png} 
    ...
    \chapter{Study Framework}\label{survey-framework}
        ...
        \section{Statistical significance}\label{doe}
            ...
            The calculation and proof of these paramenters is done in section \ref*{findings}.
            Since the probability distribution and average results play a role here and without any related numbers, this part would not mean anything.
    ...
    \chapter{Survey Contents}\label{survey-contents}
        ...
        \section{Experimental Protocol}
            ...
            \begin{figure}[h]     % h=here, t=top, b=bottom, p=page
                \centering
                \includegraphics[width=0.8\textwidth]{SensorReadings.PNG} 
    ...
    \chapter{Findings}\label{findings}
        ...
        \section{Age as a factor in BCI usage}\label{findings-age}
            ...
            \begin{figure}[h]     % h=here, t=top, b=bottom, p=page
                \centering
                \includegraphics[width=0.8\textwidth]{DetectionRegression.png}\label{regression}
            ...
            This table shows the power of the research
