...
\begin{document}
    ...
    \chapter{Survey results}
        ...
        \section{Conduction of the experiment and first glance }

            The study gathered 1370 different target data hits from 28 participants. Two participants had not undergone the experiment itself due to an insufficient calibration score. One case was due to missing glasses for a clear view of the screen and another case had concentration problems. Both cases were in the above 60 age group.
            ...
            Eye strain was reported from four participants. There was no prevalence among a certain age group in this case. Two participants wore contact lenses. One participant reported that the focus on the experiment made her forget about blinking her eyes.

            Two participants reported that they felt the SSVEP physically inside their brain in a pulsating manner. However, this was not reported to be painful.

            In many cases the calibration wasn't successful at first try. Usually an at least sufficient score was reached after 3-5 attemps. Also for some participants the optimal sensor position was a different place on the back of the skull than recommended by \textit{NextMind}. In these cases the results we perfect instantly after a relocation of the sensor to a different position.

        \todo{evaluate the following topics:}

        \begin{itemize}
            \item scatterplot data points
            \item results from post survey
            ...
            \item special thing while conducting experiment (sensor position moving (paul), calibration quality, people complaining about dry eyes, ...)
            \item Telemetry evaluation (some box plots or so...)
            \item What happens, if sensor moves bc subjects turns the head
            \item General Opinions about technology
            \item impact of gender and glasses
        \end{itemize}
