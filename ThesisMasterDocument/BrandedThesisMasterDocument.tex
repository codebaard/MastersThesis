...
\begin{document}
    ...
    \chapter{Study Framework}\label{survey-framework}
        ...
        \section{Statistical significance}\label{doe}
            ...
            \begin{itemize}
                \item Initially three buckets, but many older people had concentration, therefore: 0-20, 20-40, 40-60, 60+
                \item Say: Rejected, if mean timing of 40+ is slower than z-Score of ~2 sigma (95\%). 
                \item Calcluate according to z-score the real value in dataset (z -> x bar).
                \item This means: Reject H0, when mean timing is slower than x bar.
                \item Alpha risk (H0 is false) should be less than 5\%
                \item Beta Risk (H0 is true but rejected) is
            \end{itemize}
