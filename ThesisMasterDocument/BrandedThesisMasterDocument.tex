...
\begin{document}
    ...
    \chapter{Survey Contents}\label{survey-contents}
        ...
        \section{Experimental Protocol}
            ...
            The data was collected in a single session lasting between 10-20mins with each participant. Each session started with the participant having to complete the first questionnaire \todo{Appendix!} and and the form of consent for anonymized data processing. At this stage potential hazards, problems and dispositions as discussed in section \ref{considerations} were identified. One individual could not participate as she had epilepsy, what might have gotten triggered by the experiment.
            Afterwards each participant was introduced into the experiment. The working principle of a SSVEP was explained and questions regarding data privacy were discussed. Subsequently the user has been shown the GUI of the experiment with a short introduction about  the nature of the task.
            ...
            Then the experiment was started. The participant had to perform 50 neurotag activations. Each one consisted of a visual que (see figure \ref*{gui-remote}) on which the participant had to focus on. Upon activation of this neurotag, the readings were saved to the logfile (see \todo{Appendix logfile}) and the next cue was given. in order to keep the $t1$ timing as short as possible.

            After completion of the experiment, each participant had to fill the second questionnaire \todo{Appendix 3}, which gathered information about the experiment such as wearing comfort, perceived difficulty and questions about the opinion towards the technology in general. 
    ...
    \appendix
        ...
        \chapter{Material}
            ...
            \input{Questionnaire-Prior.tex}\label{q-prior}
            \input{InfoSheetAndConsent.tex}\label{consent}
            \input{Questionnaire-Post.tex}\label{q-post}
