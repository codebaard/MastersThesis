...
\begin{document}
    ...
    \chapter{Findings}\label{findings}
        ...
        \section{Age as a factor in BCI usage}\label{findings-age}
            ...
            Section \ref*{correlation} discussed, how a regression graph will be used in order to identify a trend between age and expected performance in regards to BCI usage. Figure \ref*{regression} shows thisregression graph with the defined 95\% confidence interval:
        ...
        \section{Mathematical proof}\label{mafs}
            ...
            The regression graph in figure \ref*{regression} alone does not sufficiently proof that the data in fact are significantly related. Therefore the probability of a \textit{Type II Error}, which is represented by the $\beta$ parameter has to be calculated. To do so, the following parameters have to be calculated first in the following part.
