...
\begin{document}
    ...
    \chapter{Findings}\label{findings}
        ...
        \section{Mathematical proof}\label{mafs}
            ...
            Where $x=\frac{1-\alpha}{2}$, $\mu$ is the mean of the sample, which results to 5.37s and $\sigma$ is the sample standard deviation which results to 9.11. The value for $\alpha$ in this case is set to 10s, since this is roughly double the mean of all timings. Using that values, the Z-Score results to:
