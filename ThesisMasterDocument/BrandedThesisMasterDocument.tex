    ...
    \chapter{Survey Contents}\label{survey-contents}
        ...
        \section{What tools will be used}
            ...
            \paragraph{Pen and paper questionnaire}
                ...
                A questionnaire will be used to collect anonymized demographic data from the participant. This is necessary for the evaluation of the results. Among demographic data and self assessments the questionnaire will also ask for opinions. See section \ref*{datacollection} for details and the full survey at section \ref*{survey}.
