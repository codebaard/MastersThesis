...
\begin{document}
    ...
    \chapter{Findings}\label{findings}
        ...
        \section{Mathematical proof}\label{mafs}
            ...
            This variable $r$ will be later used as the effect size in the $\beta$ calculation.
            ...
            Where $x = 1-\alpha/2$, \mu is the mean of the sample and and \sigma is the sample standard deviation. Using that values, the Z-Score results to:
