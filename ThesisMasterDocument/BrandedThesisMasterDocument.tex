...
\begin{document}
    ...
    \chapter{Survey Framework}\label{survey-framework}
        ...
        To answer the first question regarding previous studies to build upon, none of the studies discussed in section \ref*{related-work} had the age as a core point. Nor were there any conclusions drawn from a study, which found that age had a significant impact on the results.
        ...
        \section{Time vs Age correlation}\label{correlation}
            ...
            % The most widely adopted metric is the \textit{Information Transfer Rate} or \textit{ITR} in short, according to \cite[1]{Yuan.2013}. This metric was conceived by \cite{Wolpaw.1998} and depicts the bits/trial:

            % \begin{equation}\label{itr-basic}
            %    B = log_{2} N + P log_{2} P + (1-P) log_{2} [(1-P)/(N-1)]
            % \end{equation}

            % Where $N$ is the total number of choices for a user to choose from and $P$ is the probability that a desired or required choice in the experiment will be selected, therefore posing also a metric of accuracy. In the context of this study a symbol is equivalent to a single \textit{choice} on the remote control (see Section \ref*{use-case}). Due to the nature of the experiment, where every choice is selected eventually, the distinction cannot be made by simply looking at the probability of a selection, because it will always be 1, hence the ITR will always have the maximum value for every subject. Therefore, the desired choice will be determined for every cue by grouping into different timing groups. The number of timing groups will be denoted by $N$ and the 

            % However, \cite[4]{Yuan.2013} summarized certain contraints which have to be met, in order to ensure the applicability of this formula:
    ...
    \chapter{Survey Contents}\label{survey-contents}
        ...
        \section{Remote control interface}
            ...
            In section \ref*{itr} the \textit{Goal Directed Behaviour} was an important point in regards to the interface design. This was an important aspect to avoid a bias in the resulting ITR. Although the interface shown in figure \ref*{gui-remote} gives visual cues to the participant, this is in line with the constraints for the ITR. The reason being that there \textit{has} to be at least one cue to show the participant what he has to aim for. Otherwise the experiment would be meaningless. Apart from that cue, there are no other cues or aids present like a timer, counter or feedback on the quality of the recognition.
        ...
        \section{How are the age groups structured}
            ...
            \todo{Write some elaborate text about the age distribution}

            \begin{figure}[h]     % h=here, t=top, b=bottom, p=page
                \centering
                \includegraphics[width=0.8\textwidth]{ageDistribution.png} 
        ...
        \section{Experimental Protocol}
            ...
            \begin{figure}[h]     % h=here, t=top, b=bottom, p=page
                \centering
                \includegraphics[width=0.8\textwidth]{lotta.jpg} 
    ...
    \chapter{Survey results}
        ...
        \section{Raw results}
            ...
            \begin{figure}[h]     % h=here, t=top, b=bottom, p=page
                \centering
                \includegraphics[width=0.8\textwidth]{TargetTimeHistogram.png} 
            ...
            \begin{figure}[h]     % h=here, t=top, b=bottom, p=page
                \centering
                \includegraphics[width=0.8\textwidth]{TargetTimeHistogram_narrow.png} 
        ...
        \section{Telemetry}
            ...
            \begin{figure}[h]     % h=here, t=top, b=bottom, p=page
                \centering
                \includegraphics[width=0.8\textwidth]{telemetry.png} 
        ...
        \section{Demographic differences}
            ...
            When the genders are compared side by side in figure \ref*{gender}, there is a tendency of women having a more consistent timing. The average value of both in approximately on the same level but the male results have a larger upper quartile and whisker therefore being less consistent in timing. As in figure \ref*{time-hist-narrow}, the window was narrowed down to 10s max, to cut large outliers. \todo{Check if there is a skew in age/gender distribution}.
            ...
            \begin{figure}[h]     % h=here, t=top, b=bottom, p=page
                \centering
                \includegraphics[width=0.8\textwidth]{timeDistributiion.png} 
        ...
        \section{Detection time differences for each target}
            ...
            \begin{figure}[h]     % h=here, t=top, b=bottom, p=page
                \centering
                \includegraphics[width=0.8\textwidth]{targets.png} 
                \caption{Detection times for the different targets \todo{Correct  X-axis}}\label{targets}
            \end{figure}
        ...
        \section{Questionnaire Results}
            ...
            \begin{figure}[h]     % h=here, t=top, b=bottom, p=page
                \centering
                \includegraphics[width=0.8\textwidth]{SurveyResults.png} 
    ...
    \chapter{Findings}
        ...
        \section{Interpretation of the collected data}\label{operationalization}
            ...
            \todo{use results to construct an argument about statistical significance (DOE)}
