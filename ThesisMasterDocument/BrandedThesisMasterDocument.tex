...
\begin{document}
    ...
    \chapter{Survey Structure and layout}
        ...
        \section{Information Transfer Rate}\label{itr}
            ...
            In section \ref*{survey-main} the design of the interface will be shown and proven that all these criteria will be met. It has to be noted however that although an application violates the aforementioned criteria, the ITR might still be applicable if measures are being implemented to correct for the resulting bias.
        ...
        \section{Survey}\label{survey-main}
