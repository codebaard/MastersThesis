...
\begin{center}
\textbf{\huge Questionnaire prior to experiment \LaTeX}
\end{center}\vskip1em
...
\Qitem{ \Qq{Tragen Sie eine Brille?} \hskip0.5cm Yes \QO{} \hskip0.5cm No \QO{}}

\Qitem{ \Qq{Leiden Sie unter neurologischen Beeinträchtigungen (Demenz, Epilepsie, etc.) ?} \hskip0.5cm Yes \QO{} \hskip0.5cm No \QO{}}

\Qitem{ \Qq{Nehmen Sie Medikamente zu sich, die sich auf das Gehirn auswirken?} \hskip0.5cm Yes \QO{} \hskip0.5cm No \QO{}}

\Qitem{ \Qq{Haben Sie in den letzten 24h Alkohol zu sich genommen?} \hskip0.5cm Yes \QO{} \hskip0.5cm No \QO{}}
